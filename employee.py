...
match action:
    ...
    case "Tampilkan Grafik":
        ...
        st.markdown("""
            ...
            Kesimpulan umum yang dapat diambil dari analisis ini adalah bahwa faktor utama yang memengaruhi keputusan karyawan untuk bertahan atau mengundurkan diri adalah gaji dan usia, dengan karyawan yang lebih muda dan masih lajang cenderung memiliki tingkat attrition yang lebih tinggi. Selain itu, kepuasan kerja dan work-life balance juga memainkan peran penting, di mana karyawan yang merasa tidak puas atau mengalami ketidakseimbangan antara pekerjaan dan kehidupan pribadi lebih rentan untuk mengundurkan diri. Pengalaman kerja serta komitmen pekerjaan, seperti pekerjaan sampingan atau bekerja di banyak perusahaan, turut meningkatkan risiko attrition. Pemahaman terhadap kategori sosial dan demografis karyawan, seperti status pernikahan dan pola perjalanan bisnis, dapat menjadi indikator tambahan yang berguna untuk memprediksi siapa yang lebih cenderung untuk berhenti dari pekerjaan mereka.
            """)
